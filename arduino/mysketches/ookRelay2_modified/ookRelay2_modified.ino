...
#define DEBUG_LED 13// define as pin 1..19 to blink LED on each pin change
...
static void rf12_init_OOK () {
    ...
    rf12_control(0xA640); // A68A    868.2500 MHz
    rf12_control(0xc691); // C691    c691 datarate 2395 kbps 0xc647 = 4.8kbps 
    rf12_control(0x948B); // 9489    VDI; FAST;200khz;GAIn -6db; DRSSI 97dbm 
