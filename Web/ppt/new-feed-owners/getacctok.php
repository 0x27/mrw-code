...
//$request_token='mls8fzuiXTXp0bFVkXh8sOl9TLtWR5ZgDBNi2WPBk';
//$request_token_secret='kK1HNsglHifboKUKTZsma4UiGUH1QivCWw3OjMJNqjU';
//$oauth_verifier= '2131373';
...
*/
function get_access_token($consumer_key, $consumer_secret, $request_token, $request_token_secret, $usePost=false, $useHmacSha1Sig=true, $passOAuthInHeader=true)
