...
// Uncomment this to test getting the authorisation URL using PHP on the command line
// get_auth_url();
...
function get_auth_url() {
  ...
  if (! empty($retarr)) {
    ...
    if ($info['http_code'] == 200 && !empty($body)) {
       echo "http://api.twitter.com/oauth/authorize?" .
          rfc3986_decode($body) . "\n";
    }
  }
}

// Don't include exit(0); when embedded the script in a web page
//exit(0);
