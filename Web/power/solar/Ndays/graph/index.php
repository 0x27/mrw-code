<!DOCTYPE html>
 ...
 <head>
   ...
   <title>Recent Solar Generation</title>
  ...
  <script id="source" language="javascript" type="text/javascript">
   function createGraph() {
      $.get('/power/solar/Ndays/index2.php', function(d){
          var solarToday = [];
...
<body>
  ...
  <div id="thegraph" style="width:900px;height:650px;"></div>
</body>
</html>
