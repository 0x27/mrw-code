...
$queryString = "SELECT unix_timestamp(timestamp),voltage FROM wirelessnodes WHERE nodeid = 2 AND timestamp > date_sub(curdate(), INTERVAL " . ($numberOfDaysHistory + 2) . " DAY) ORDER BY timestamp";
