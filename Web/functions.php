<script type="text/javascript">
   ...
   function flashStopButton() {
      $('#stopbutton').attr({
         'src': 'icons/music/ButtonStopSet.png'
      });
   ...
   function flashBackButton() {
      $('#backbutton').attr({
         'src': 'icons/music/ButtonFirstSet.png'
      });
      setTimeout('resetButtons()', 600);
   }
   ...
   function flashForwardButton() {
      $('#forwardbutton').attr({
         'src': 'icons/music/ButtonLastSet.png'
      });
      setTimeout('resetButtons()', 600);
   }
   ...
   function resetButtons() {
      $('#backbutton').attr({
         'src': 'icons/music/ButtonFirst.png'
      });
      $('#forwardbutton').attr({
         'src': 'icons/music/ButtonLast.png'
      });
      $('#stopbutton').attr({
         'src': 'icons/music/ButtonStop.png'
      });
      $('#shufflebutton').attr({
         'src': 'icons/music/ButtonShuffle.png'
      });
   }
   ...
   function updateButtons() {
      if (paused) {
         $('#pausebutton').attr({
            'src': 'icons/music/ButtonPauseSet.png'
         });
         $('#playbutton').attr({
            'src': 'icons/music/ButtonPlay.png'
         });
      } else if (playing) {
         $('#pausebutton').attr({
            'src': 'icons/music/ButtonPause.png'
         });
         $('#playbutton').attr({
            'src': 'icons/music/ButtonPlaySet.png'
         });
      } else {
         $('#pausebutton').attr({
            'src': 'icons/music/ButtonPause.png'
      ...
      if (random) {
         $('#randombutton').attr({
            'src': 'icons/music/ButtonRandomSet.png'
         });
      } else {
         $('#randombutton').attr({
            'src': 'icons/music/ButtonRandom.png'
         });
      }
   }
