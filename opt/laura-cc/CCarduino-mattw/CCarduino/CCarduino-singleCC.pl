...
# read currentcost data from realtime for one nominated meter, and 
# package it up to send to serial port.

# Andy S-C 1-Jan-10 (my first program in 2010!)
# Changed to deal with just single CC topic - LauraCowen 11-Dec-10

####################################################################

# nominate two CurrentCost data topics here

$L_topic = "PowerMeter/CC/mattw";
